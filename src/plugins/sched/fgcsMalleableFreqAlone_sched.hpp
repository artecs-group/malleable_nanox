#ifndef _FGCS_MALLEABLE_FREQ_ALONE_SCHED_HPP_
#define _FGCS_MALLEABLE_FREQ_ALONE_SCHED_HPP_
...
namespace nanos {    
	...
	class FgcsMalleableFreqAlone : public SchedulePolicy {
	private:
	...
	public:
	    FgcsMalleableFreqAlone();
	    virtual ~FgcsMalleableFreqAlone();
	...
	class FgcsMalleableFreqAlonePlugin : public Plugin {
	public:
	    FgcsMalleableFreqAlonePlugin() : Plugin( "FGCS MalleableFreq ALONE Plugin",1 ) {}

	    virtual void config ( Config &cfg ){ }
	    virtual void init() {
		sys.setDefaultSchedulePolicy(NEW FgcsMalleableFreqAlone());
	    }
	};
...
#endif //_FGCS_MALLEABLE_FREQ_ALONE_SCHED_HPP_
