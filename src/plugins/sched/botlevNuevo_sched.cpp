      ...
      class BotLevSchedPlugin : public Plugin
      {
         public:
            ...
            virtual void config ( Config &config_ )
            {
                ...
                config_.registerConfigOption ( "numSpins", new Config::IntegerVar( BotLevCfg::numSpins ), "Defines the number of spins in atIdle (work stealing)" );
...
DECLARE_PLUGIN("botlevNuevo",nanos::ext::BotLevSchedPlugin);
