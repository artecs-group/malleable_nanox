   ...
   public:
      ...
      void finalize ( void )
      {
         ...
         /* HARDCODED values */
         {
            ...
            char **val_desc = (char **) alloca( sizeof(char *) * nval );
            unsigned int i = 0;
            static std::string nanos_event_state_value_str[] = {
		"NOT CREATED", "NOT RUNNING", 
		...
		"FILL COLOR", "WAKING UP", "STOPPED", "SYNCED RUNNING",
		"MOD_ARCH", "MOD_ARCH1", "MOD_ARCH2", "MOD_ARCH3", "MOD_ARCH4",
		"DEBUG"};
