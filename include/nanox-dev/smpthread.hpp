...
namespace ext {
   ...
   class SMPThread : public BaseThread
   {
      ...
      public:
         ...
         /**@ @**/
         inline virtual int getRealCpuId() const { return _pthread.getRealCpuId(); }
         inline virtual void setAffinity( size_t cpusetsize, const cpu_set_t* cpuset) {
	     _pthread.setAffinity(cpusetsize, cpuset);
	 }  
         /**@ @**/
