 ...
 */ 
   class InstrumentationDictionary {
      ...
      public:
	    ...
	    //FGCS
	    /* 73 */ registerEventKey("n-crit","FGCS: no. ready critical tasks", true,  EVENT_DEVELOPER );
            /* 74 */ registerEventKey("n-noCrit", "FGCS: no. ready non-critical tasks", true, EVENT_DEVELOPER );
	    /* 75 */ registerEventKey("n-BIG", "FGCS: no. BIG cores", true, EVENT_DEVELOPER );
	    /* 76 */ registerEventKey("n-FUTURE_BIG", "FGCS: no. future-big cores", true, EVENT_DEVELOPER );
	    /* 77 */ registerEventKey("n-LITTLE", "FGCS: no. LITTLE cores", true, EVENT_DEVELOPER );
	    /* 78 */ registerEventKey("n-SLEEPING", "FGCS: no. sleeping cores", true, EVENT_DEVELOPER );
	    /* 79 */ registerEventKey("n-TOTAL", "FGCS: no. total cores", true, EVENT_DEVELOPER );
	    /* 80 */ registerEventKey("fgcs_2", "FGCS: aux2", true, EVENT_DEVELOPER );
	    /* 81 */ registerEventKey("fgcs_3", "FGCS: aux3", true, EVENT_DEVELOPER );
	    /* 82 */ registerEventKey("fgcs_4", "FGCS: aux4", true, EVENT_DEVELOPER );
	    /* 83 */ registerEventKey("fgcs_5", "FGCS: aux5", true, EVENT_DEVELOPER );
	    /* 84 */ registerEventKey("fgcs_6", "FGCS: aux6", true, EVENT_DEVELOPER );
